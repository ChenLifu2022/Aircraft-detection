...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', type=str, default='runs/exp49/weights/last.pt', help='initial weights path')
    parser.add_argument('--cfg', type=str, default='MGCAM.yaml', help='model.yaml path') #yolov5s.yaml yolov5s_involution5x5.yaml
    ...
    print(opt.cfg)
    print(type(opt.cfg))
    if opt.cfg =='yolov5s.yaml':
       from models.yolo import Model

    if opt.cfg =='EBPA2N.yaml':
       from EBPA2N.EBPA2N import Model

    if opt.cfg =='MGCAM.yaml':
       from MGCAM.MGCAM import Model
